...
class KsGlobalDiscountInvoice(models.Model):
    ...
    price_after_discount = fields.Monetary(string='Price After Discount', readonly=True, compute='_compute_amount', store=True,
    ...
    def ks_calculate_discount(self):
        for rec in self:
            ...
            if rec.invoice_line_ids:
                tax_id = rec.invoice_line_ids[0].invoice_line_tax_ids.amount
